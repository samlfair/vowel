...
test("secretRouter: the hash input is the original path up to the segment, salt in place - frozen", () => {
  ...
  assert.equal(secretRouter("blog/hidden§purple-bear/post.md"), "blog/86f1daca4da02b2e/post.md")
  assert.equal(secretRouter("hello-world§red-whale.md"), "5b4a1426a956765a.md")
})
